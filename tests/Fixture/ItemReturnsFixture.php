 ...
 *
 */
class ItemReturnsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'item_returns_ibfk_1' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['phones', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
