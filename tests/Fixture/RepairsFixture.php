...
class RepairsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'repairs_ibfk_1' => ['type' => 'foreign', 'columns' => ['item_id'], 'references' => ['phones', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'item_id' => 1,
            'created' => '2018-07-05 18:04:15',
            'modified' => '2018-07-05 18:04:15'
        ],
    ];
}
